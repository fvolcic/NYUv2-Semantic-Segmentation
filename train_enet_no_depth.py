...
MODEL_OUTPUT_PATH = "trained_models/enet_no_depth_nyuv2_attempt2/"
NUM_EPOCHS = 405
START_EPOCH=80
...
model = enet(num_classes=14, in_channels=3).to(device) # 14 classes, 4 channels
...
for epoch in range(NUM_EPOCHS):
    ...
    for data in tqdm(train_loader):
        ...
        x = rgb #torch.cat((rgb, depth), dim=1)
