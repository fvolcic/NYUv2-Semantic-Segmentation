...
MODEL_OUTPUT_PATH = "trained_models/unet_no_depth/"
NUM_EPOCHS = 405
...
starting_model = f"trained_models/unet_no_depth/enet_epoch_{STARTING_EPOCH}.pth"
model.load_state_dict(torch.load(starting_model))
model.train()
